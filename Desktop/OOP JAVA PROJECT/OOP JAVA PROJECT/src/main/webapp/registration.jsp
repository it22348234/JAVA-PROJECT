                ...
                <div class="form-content">
                    <div class="form-items">
                      <%
                        ...
                        <p>Fill in the data below. To Into the application</p>
                        <form action="<%= request.getContextPath() %>/register" method="post">
                            ...
                            <div class="col-md-12">
                             ...
                             <div class="col-md-12">
                                  <input placeholder="Display Name" required class="form-control" type="text" name="name" />
                            </div>
                            
                            <div class="col-md-12">
                            	<input name="imageUrl" type="text" class="form-control" id="profileUrl" placeholder="Enter Profile Path Image URL">
                             </div>
                        ...
                        <a class="mt-2 icon-link icon-link-hover" href="login.jsp">
  							Log In
						</a>
                    </div>
                </div>
